<template>
  <div class="container">
    <h1>アイデアを出させるアプリ</h1>
    <p class="small-description">このアプリは、あなた自身の発想を引き出す「問い生成AI」です</p>
...
例:（80文字以内の答えを3つ、番号付きで）`;
  ...
  prompt = `${rolePrefix}${intro}「${inputText.value}」というキーワードについて関連性を保ちながら、他の分野や用途に応用・拡張することで、思考を促す問いを1つ作成してください。前の問いはリセットし、内容を引き継がないようにしてください。
...
例:（80文字以内の答えを3つ、番号付きで）`;
  ...
  prompt = `${rolePrefix}${intro}「${inputText.value}」というキーワードに対して、キーワード内の単語をひとつを取り出して連想される単語を1つ掛け合わせて、思考を促す問いを1つ作成してください。前の問いはリセットし、内容を引き継がないようにしてください。
