...
例:（80文字以内の答えを3つ、番号付きで）`;
  ...
  prompt = `${intro}「${inputText.value}」というテーマについて、立場や視点を切り替えて考えることで、新たな発想を促す問いを1つ作成してください。たとえば「子どもだったら？」「外国人だったら？」「動物だったら？」など、視点の転換を活かしてください。
...
例:（80文字以内の答えを3つ、番号付きで）`;
  ...
  prompt = `${intro}「${inputText.value}」というテーマについて、未来の技術や社会、価値観の変化を想定しながら、思考を促す問いを1つ作成してください。10年後、50年後など、時間軸をずらして考えてください。
...
例:（80文字以内の答えを3つ、番号付きで）`;
  ...
  prompt = `${intro}「${inputText.value}」というテーマについて、制限や条件を設けることで、創造性を引き出す問いを1つ作成してください。たとえば「予算が100円しかない」「時間が5分しかない」「道具が使えない」など、制約を活かしてください。
